...
const PROTECTED_PREFIXES = ["/dashboard", "/leaderboard", "/predictions", "/teams", "/transfers", "/profile"];
...
export const config = {
  matcher: ["/dashboard/:path*", "/leaderboard/:path*", "/predictions/:path*", "/teams/:path*", "/transfers/:path*", "/profile/:path*", "/admin/:path*"],
};
